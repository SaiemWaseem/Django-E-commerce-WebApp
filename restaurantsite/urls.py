...
from customer.views import Index, Garage, login_view, register, view_profile, LogoutView, order_view, product, add_to_cart, remove_from_cart, view_cart, view_order, user_orders
from car.views import Revenue_Products, Revenue_Categories, Revenue_Forecast
urlpatterns = [
    path('admin/', admin.site.urls),
    path('', Index.as_view(), name='index'),
    path('Garage/', Garage.as_view(), name='garge'),
